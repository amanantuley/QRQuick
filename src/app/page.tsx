...
export default function Home() {
  return (
    <main className="flex min-h-screen w-full flex-col items-center bg-background px-4 py-8 sm:px-6 lg:px-8">
      <div className="flex w-full max-w-6xl flex-col items-center animate-fade-in-down">
      ...
      <div className="flex flex-grow w-full items-center justify-center py-8 animate-fade-in-up [animation-delay:200ms]">
      ...
      <footer className="flex items-center gap-2 text-center text-sm text-muted-foreground animate-fade-in-up [animation-delay:400ms]">
